...
import { Segment, Header, Button, Dropdown as Dropdown$1, Message, Loader, Form, Modal, Menu } from 'semantic-ui-react';
...
var enhancer = composeEnhancers(applyMiddleware.apply(undefined, middleware.concat([logger])), applyMiddleware.apply(undefined, middleware)
...
axios.interceptors.response.use(function (response) {
  ...
  var msg = get(error, "response.data.msg", null);
...
var MyPersonalProfile = function (_Component) {
    ...
    createClass(MyPersonalProfile, [{
        ...
        value: function render() {
            ...
            var companyName = get(this.props, "userInitialData.userBasicInfo.companyName", "");
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        profileImage ? React.createElement("div", { className: "profile-pic-div modal-profile-image", style: { backgroundImage: "url(" + profileImage + ")" } }) : React.createElement(
                            "div",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                "div",
                                { "class": "form-column" },
                                React.createElement(Input, { value: contactName, label: "Full Name", onChange: function onChange(e) {
                                        return _this3.handleUpdate("contactName", e);
                                    }, charsOnly: true, rounded: true }),
                                React.createElement(Input, { value: email, label: "Email", onChange: function onChange(e) {
                            ...
                            React.createElement(
                                ...
                                React.createElement(Dropdown, { value: phoneOptions[phoneType], handleSelect: function handleSelect(e) {
                                        return _this3.handleUpdate("phoneType", e);
                                    }, list: phoneOptions, label: "Phone Type", rounded: true }),
                                React.createElement(
                                    "div",
                                    { className: "phone-wrapper" },
                                    React.createElement(Input, { value: phone, label: "Phone Number", onChange: function onChange(e) {
...
var DrayageCompanyProfile = function (_Component) {
  ...
  function DrayageCompanyProfile(props) {
    ...
    _this.componentDidMount = function () {
      ...
      var dispatcherPhoneNo = get(_this.props, "data.companyProfile.dispatcherPhone.phoneNumber", "");
      var isd = get(_this.props, "data.companyProfile.dispatcherPhone.isd", "");
  ...
  createClass(DrayageCompanyProfile, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.state.error.length > 0 && React.createElement(
          "div",
          {
            style: {
              marginLeft: "10px",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            this.state.imgLoading && React.createElement(Loader, { active: true, inline: "centered", size: "small" }),
            this.state.image.preview ? React.createElement("img", {
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { className: "phone-wrapper" },
                React.createElement(Input, { value: this.state.dispatcherPhoneNum, label: "Phone Number", onChange: function onChange(e) {
...
var ServiceArea = function (_Component) {
  ...
  function ServiceArea(props) {
    ...
    _this.validate = function () {
      ...
      var result = true;
      var errorArr = [];
      if (_.isEmpty(_this.state.selectedArea)) {
        result = false;
        errorArr.push({
          key: "area",
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(Map, { data: this.state.selectedArea })
            )
          ),
          React.createElement(
            Button,
  ...
  createClass(LegalDocViwer, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.props.visible && this.state.signedDoc && React.createElement(
          "div",
          {
            style: {
              display: "flex",
          ...
          React.createElement(
            ...
            this.state.numPages.length > 0 && this.state.numPages.map(function (item, index) {
              return React.createElement(Page, { pageNumber: item, loading: "", className: "pdf-view" });
            })
          )
        )
      );
...
var Legal = function (_Component) {
  ...
  function Legal(props) {
    ...
    _this.renderAddDocumentModal = function (existingDocName) {
      return _this.state.options.visible ? React.createElement(
        "div",
        { style: { marginTop: "2%" } },
        React.createElement(
          Form,
          ...
          React.createElement(
            ...
            _this.state.options.type === "OTHER" ? React.createElement(
              Form.Field,
              null,
              React.createElement(
                "label",
            ...
            _this.state.options.type === "COPY OF THE INSURANCE" && React.createElement(
              Form.Field,
              null,
              React.createElement(
                "label",
    ...
    _this.renderList = function (title, index, item) {
      return React.createElement(LegalDocViwer, {
        key: index,
        title: title,
        index: index,
  ...
  createClass(Legal, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.validate() ? "" : React.createElement(
          "p",
          { style: { color: "red" } },
          "\"Please upload Copy of Insurance before uploading any other document\""
        ),
        this.state.loading === true ? React.createElement(Loader, { active: true, style: { marginTop: "30%" }, inline: "centered", size: "medium" }) : React.createElement(
          "div",
  ...
  function Pricing(props) {
    ...
    _this.renderInput = function (divStyle, inputStyle, name, value, placeholder, key, handleChange) {
      return React.createElement(
        "div",
        { style: divStyle },
        name === "unitPrice" && value.length > 0 && React.createElement(
          "span",
          {
            style: {
              position: "absolute",
    ...
    _this.renderRow = function (item, index) {
      return React.createElement(
        ...
        }, "Charge Name", "30%") : React.createElement(
          "span",
          {
            style: {
              display: "flex",
    ...
    _this.renderDocument = function () {
      return React.createElement(
        ...
        !_.isEmpty(_this.props.data.pricing.pricingListDocument) && React.createElement(
          "div",
          { style: { marginBottom: "10px" } },
          _this.renderButton("Attach Price List", _this.handleAddDocument)
        ),
        React.createElement(RenderDocument, {
          visible: true,
  ...
  createClass(Pricing, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        this.state.loading2 === true ? React.createElement(
          "div",
          {
            style: {
              height: "100vh",
          ...
          React.createElement(Loader, { active: true, inline: "centered", size: "medium" })
        ) : React.createElement(
          "div",
          {
            style: {
          ...
          this.state.pricingItems.length > 0 && React.createElement(
            "div",
            {
              style: {
                display: "flex",
          ...
          this.state.pricingItems.length > 0 && React.createElement("div", {
            style: {
              borderTopWidth: "1px",
              borderStyle: "solid",
              borderColor: "#D4D4D4"
          ...
          React.createElement(
            ...
            _.isEmpty(this.props.data.pricing.pricingListDocument) && this.renderButton("ADD PRICE LIST", this.handleAddDocument, {
              marginLeft: "-10px",
              marginTop: "10px"
            })
          ),
...
var RenderDocument = function (_Component2) {
  ...
  createClass(RenderDocument, [{
    ...
    value: function render() {
      ...
      return this.props.visible && this.state.signedDoc && React.createElement(
        "div",
        {
          style: {
            // display: "flex",
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement("input", { id: "name", name: "name", placeholder: "Name", required: true, onChange: onChange })
          ),
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement(Dropdown$1, { style: { padding: "10px" }, options: isdOptions, id: "driversLicenseState", name: "isdCode", placeholder: "ISD Codes", onChange: function onChange(e, data) {
          ...
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement("input", { id: "phoneNumber", name: "phoneNumber", placeholder: "Phone Number", type: "number", required: true, onChange: onChange })
          ),
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement(Dropdown$1, { style: { padding: "10px" }, options: stateList, id: "driversLicenseState", name: "driversLicenseState", placeholder: "Driver's License State", onChange: function onChange(e, data) {
          ...
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement("input", { id: "driversLicenseNumber", name: "driversLicenseNumber", placeholder: "Driver's License Number", onChange: onChange })
          ),
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement("input", { id: "name", name: "name", placeholder: "Name", value: name, required: true, onChange: onChange })
          ),
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement("input", { id: "phoneNumber", name: "phoneNumber", placeholder: "Phone Number", value: phoneNumber, type: "number", required: true, onChange: onChange })
          ),
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement(Dropdown$1, { style: { padding: "10px" }, options: stateList, id: "driversLicenseState", name: "driversLicenseState", placeholder: "Driver's License State", value: driversLicenseState, onChange: function onChange(e, data) {
                onChangeList("driversLicenseState", data.value);
              } })
          ),
          React.createElement(
            Form.Field,
            { className: "create-user-input" },
            React.createElement("input", { id: "driversLicenseNumber", name: "driversLicenseNumber", placeholder: "Driver's License Number", value: driversLicenseNumber, onChange: onChange })
          ),
          React.createElement(
            "p",
            { className: "errorMessage", style: { color: "red", textAlign: "center", fontWeight: "bold" } },
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement("img", { src: "/images/add-document.svg", className: "add_icon" }),
                React.createElement(
                  "span",
          ...
          React.createElement(
            ...
            showMsg === true && React.createElement(Message, {
          ...
          React.createElement(
            ...
            " ",
            React.createElement("br", null),
            addTruckers && React.createElement(AddTruckers, {
            ...
            updateTruckers && React.createElement(UpdateTruckers, {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          this.state.loading === true ? React.createElement(Loader, { active: true, inline: "centered", size: "medium" }) : React.createElement(
            'div',
            ...
            React.createElement(
              ...
              React.createElement('div', { style: modalOpen !== modals.myPersonalProfile ? invisible : null, className: 'menu-item-active' }),
              React.createElement(
                Menu.Item,
                { onClick: function onClick() {
            ...
            React.createElement(
              'div',
              { className: 'menu-item-group' },
              React.createElement('div', { style: modalOpen !== modals.drayageCompanyProfile ? invisible : null, className: 'menu-item-active' }),
              React.createElement(
                Menu.Item,
                { onClick: function onClick() {
            ...
            React.createElement(
              'div',
              { className: 'menu-item-group' },
              React.createElement('div', { style: modalOpen !== modals.serviceArea ? invisible : null, className: 'menu-item-active' }),
              React.createElement(
                Menu.Item,
                { onClick: function onClick() {
            ...
            React.createElement(
              'div',
              { className: 'menu-item-group' },
              React.createElement('div', { style: modalOpen !== modals.docs ? invisible : null, className: 'menu-item-active' }),
              React.createElement(
                Menu.Item,
                { onClick: function onClick() {
            ...
            React.createElement(
              'div',
              { className: 'menu-item-group' },
              React.createElement('div', { style: modalOpen !== modals.mytruckers ? invisible : null, className: 'menu-item-active' }),
              React.createElement(
                Menu.Item,
                { onClick: function onClick() {
            ...
            React.createElement(
              'div',
              { className: 'menu-item-group' },
              React.createElement('div', { style: modalOpen !== modals.accessorialCharges ? invisible : null, className: 'menu-item-active' }),
              React.createElement(
                Menu.Item,
                { onClick: function onClick() {
        ...
        React.createElement(
          ...
          modalOpen === modals.myPersonalProfile && React.createElement(MyPersonalProfile, {
          ...
          modalOpen === modals.drayageCompanyProfile && React.createElement(DrayageCompanyProfile, {
            toggleModal: function toggleModal() {
              return _this2.setState({ modalOpen: "" });
            },
            data: data,
          ...
          modalOpen === modals.serviceArea && React.createElement(ServiceArea, {
            toggleModal: function toggleModal() {
              return _this2.setState({ modalOpen: "" });
            },
            data: data,
          ...
          modalOpen === modals.docs && React.createElement(Legal, {
            toggleModal: function toggleModal() {
              return _this2.setState({ modalOpen: "" });
            },
            data: data,
          ...
          modalOpen === modals.mytruckers && React.createElement(MyTruckers, {
            toggleModal: function toggleModal() {
              return _this2.setState({ modalOpen: "" });
            },
            data: data,
          ...
          modalOpen === modals.accessorialCharges && React.createElement(Pricing, {
            toggleModal: function toggleModal() {
              return _this2.setState({ modalOpen: "" });
            },
            data: data,
...
export { HamburgerMenu, APPLICATION_CLICKED, OPPORTUNITY_ARROW_CLICKED, OPPORTUNITY_BID_CLICKED, ADDITONAL_CHARGE_DONE_CLICKED, ADDITONAL_CHARGE_CANCEL_CLICKED, OPPORTUNITY_BID_MODAL_BID_CLICKED, OPPORTUNITY_BID_MODAL_PORT_ADDITIONAL_CHARGE_CLICKED, OPPORTUNITY_BID_MODAL_SUBMIT_CLICKED, OPPORTUNITY_BID_MODAL_CANCEL_CLICKED, LANE_BID_DONE_CLICKED, LANE_BID_CANCEL_CLICKED, LANE_BID_ADDITIONAL_CHARGE_CLICKED, PARTNER_STANDARD_ADDITIONAL_CHARGES, API_GET_OPPORTINITY_LIST, API_GET_OPPORTINITY_DETAILS, SET_OPPORTUNITY_BID_DATA, LANE_BID_SELECT_CLICKED };
